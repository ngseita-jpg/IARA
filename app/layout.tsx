...
export const metadata: Metadata = {
  ...
  description: 'Sua assessora de comunicação com IA. 10 módulos integrados: roteiros, carrosseis, thumbnails, Faísca Criativa, oratória, mídia kit e muito mais. Feito para criadores brasileiros.',
