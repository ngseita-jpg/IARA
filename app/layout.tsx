...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      offers: [
        { '@type': 'Offer', name: 'Plus',         price: '59.90',  priceCurrency: 'BRL' },
        { '@type': 'Offer', name: 'Premium',      price: '129.00', priceCurrency: 'BRL' },
        { '@type': 'Offer', name: 'Profissional', price: '249.00', priceCurrency: 'BRL' },
        { '@type': 'Offer', name: 'Agência',      price: '499.00', priceCurrency: 'BRL' },
      ],
    },
  ],
}
