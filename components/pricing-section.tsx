...
export function PricingSection() {
  ...
  async function assinar(plano: PlanoId) {
    ...
    if (plano === 'agencia') {
      window.location.href = 'mailto:iarahubapp@gmail.com?subject=Quero%20o%20plano%20Ag%C3%AAncia&body=Ol%C3%A1!%20Tenho%20interesse%20no%20plano%20Ag%C3%AAncia%20do%20Iara%20Hub.%20Pode%20me%20chamar?'
      return
    }
